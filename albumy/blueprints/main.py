...
from albumy.blueprints.helpers.ml_helpers import (
...
def upload():
    if request.method == "POST" and "file" in request.files:
        ...
        file_location = os.path.join(current_app.config["ALBUMY_UPLOAD_PATH"], filename)
        # Generate alt text
        description = generate_image_caption(file_location)
        if description:
